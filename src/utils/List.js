...
export const refreshNotificationsList = () => store.dispatch(refreshList('notificationsList'));


export const refreshAddressList = () => store.dispatch(refreshList('addressList'));
